...
def find_gdrive_path():
    ...
    common_paths = [
        user_dir / "Google Drive",
        user_dir / "OneDrive" / "Google Drive",
        user_dir / "Desktop" / "Google Drive",
    ]
...
def main():
    ...
    try:
        ...
        print(f"   ✅ Update bot files copied to G-Drive")
    except Exception as e:
