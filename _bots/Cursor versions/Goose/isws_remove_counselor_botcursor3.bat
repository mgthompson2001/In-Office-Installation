@echo off
REM Wrapper for isws_remove_counselor_botcursor3.py
REM Auto-generated batch wrapper for: isws_remove_counselor_botcursor3.py

echo Starting isws_remove_counselor_botcursor3.py...
echo.
